...
N_atom = 2000 + (10000-2000)*(atom_index/16)
...
np.save("psi_source_well_ITE.npy", data1)
...
np.save("complete_transistor_potential.npy", data0)
np.save("real_time_evolution_time_split.npy", data1)
np.save("dimensionless_complete_transistor_potential.npy", data3)
